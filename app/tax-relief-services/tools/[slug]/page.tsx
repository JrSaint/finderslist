...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/tax-relief-services/tools/${tool.slug}` },
  };
}
...
export default async function TaxReliefToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Tax Relief Services", item: "https://finderslist.com/tax-relief-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/tax-relief-services/category/${tool.category}` },

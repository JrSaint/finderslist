...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/legal-tools/tools/${tool.slug}` },
  };
}
...
export default async function LegalToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Legal Tools", item: "https://finderslist.com/legal-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/legal-tools/category/${tool.category}` },

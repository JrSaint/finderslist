...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/applicant-tracking-systems/tools/${tool.slug}` },
  };
}
...
export default async function ATSToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Applicant Tracking Systems", item: "https://finderslist.com/applicant-tracking-systems" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/applicant-tracking-systems/category/${tool.category}` },

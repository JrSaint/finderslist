...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/home-security-systems/tools/${tool.slug}` },
  };
}
...
export default async function HomeSecurityToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Home Security Systems", item: "https://finderslist.com/home-security-systems" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/home-security-systems/category/${tool.category}` },

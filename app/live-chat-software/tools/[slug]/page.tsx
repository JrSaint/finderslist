...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/live-chat-software/tools/${tool.slug}` },
  };
}
...
export default async function LiveChatToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Live Chat Software", item: "https://finderslist.com/live-chat-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/live-chat-software/category/${tool.category}` },

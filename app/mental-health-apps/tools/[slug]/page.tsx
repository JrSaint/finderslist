...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/mental-health-apps/tools/${tool.slug}` },
  };
}
...
export default async function MentalHealthToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Mental Health Apps", item: "https://finderslist.com/mental-health-apps" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/mental-health-apps/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/appointment-scheduling-software/tools/${tool.slug}` },
  };
}
...
export default async function AppointmentSchedulingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Appointment Scheduling Software", item: "https://finderslist.com/appointment-scheduling-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/appointment-scheduling-software/category/${tool.category}` },

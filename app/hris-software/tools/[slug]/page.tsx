...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/hris-software/tools/${tool.slug}` },
  };
}
...
export default async function HRISToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "HRIS Software", item: "https://finderslist.com/hris-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/hris-software/category/${tool.category}` },

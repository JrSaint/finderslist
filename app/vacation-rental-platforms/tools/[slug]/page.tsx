...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/vacation-rental-platforms/tools/${tool.slug}` },
  };
}
...
export default async function VacationRentalToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Vacation Rental Platforms", item: "https://finderslist.com/vacation-rental-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/vacation-rental-platforms/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-insurance/tools/${tool.slug}` },
  };
}
...
export default async function BusinessInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business Insurance", item: "https://finderslist.com/business-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-insurance/category/${tool.category}` },

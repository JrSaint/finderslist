...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/warehouse-management-software/tools/${tool.slug}` },
  };
}
...
export default async function WarehouseManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Warehouse Management Software", item: "https://finderslist.com/warehouse-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/warehouse-management-software/category/${tool.category}` },

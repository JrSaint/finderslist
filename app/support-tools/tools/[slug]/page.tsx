...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/support-tools/tools/${tool.slug}` },
  };
}
...
export default async function SupportToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Support Tools", item: "https://finderslist.com/support-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/support-tools/category/${tool.category}` },

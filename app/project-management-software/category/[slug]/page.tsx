...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/project-management-software/category/${slug}` },
  };
}
...
export default async function ProjectManagementCategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: tools.map((tool, i) => ({
      ...
      url: `https://finderslist.com/project-management-software/tools/${tool.slug}`,
    })),
  };

...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  if (isFiltering) {
    return { robots: { index: false, follow: false }, alternates: { canonical: "https://www.finderslist.com/project-management-software" } };
  }
  return {
    ...
    alternates: { canonical: "https://www.finderslist.com/project-management-software" },
  };
}
...
export default async function ProjectManagementPage({ searchParams }: Props) {
  ...
  const faqJsonLd = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: (PROJECT_MANAGEMENT_EDITORIAL.faq || []).map((f) => ({
      "@type": "Question",
      name: f.question,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {!isFiltering && (
          <>
          <CategoryAtAGlance tools={allTools as never[]} basePath="/project-management-software" />
          <ComparisonTable
        ...
        <RelatedDirectories currentSlug="project-management-software" />
      </div>
    </div>
  );
}

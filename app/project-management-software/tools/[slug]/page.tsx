...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/project-management-software/tools/${tool.slug}` },
  };
}
...
export default async function ProjectManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Project Management Software", item: "https://finderslist.com/project-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/project-management-software/category/${tool.category}` },

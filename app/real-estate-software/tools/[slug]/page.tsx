...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/real-estate-software/tools/${tool.slug}` },
  };
}
...
export default async function RealEstateToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Real Estate Software", item: "https://finderslist.com/real-estate-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/real-estate-software/category/${tool.category}` },

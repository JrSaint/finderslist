...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  if (isFiltering) {
    return { robots: { index: false, follow: false }, alternates: { canonical: "https://finderslist.com/real-estate-software" } };
  }
  return {
    ...
    alternates: { canonical: "https://finderslist.com/real-estate-software" },
  };
}

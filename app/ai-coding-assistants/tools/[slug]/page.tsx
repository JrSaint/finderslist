...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ai-coding-assistants/tools/${tool.slug}` },
  };
}
...
export default async function AICodingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "AI Coding Assistants", item: "https://finderslist.com/ai-coding-assistants" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ai-coding-assistants/category/${tool.category}` },

...
export default async function SolarPanelToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Solar Panel Companies", item: "https://finderslist.com/solar-panel-companies" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/solar-panel-companies/category/${tool.category}` },

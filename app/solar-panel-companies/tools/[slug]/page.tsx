...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.finderslist.com/solar-panel-companies/tools/${tool.slug}` },
  };
}
...
export default async function SolarPanelToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: category.label, item: `https://www.finderslist.com/solar-panel-companies/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/marketing-automation-software/tools/${tool.slug}` },
  };
}
...
export default async function MarketingAutomationToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Marketing Automation Software", item: "https://finderslist.com/marketing-automation-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/marketing-automation-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.finderslist.com/ecommerce-platforms/tools/${tool.slug}` },
  };
}
...
export default async function EcommercePlatformToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: category.label, item: `https://www.finderslist.com/ecommerce-platforms/category/${tool.category}` },

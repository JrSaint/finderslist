...
export default async function EcommercePlatformToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "E-Commerce Platforms", item: "https://finderslist.com/ecommerce-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ecommerce-platforms/category/${tool.category}` },

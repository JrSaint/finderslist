    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-14">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-400">
          Found a great AI tool that&apos;s not listed? Submit it and help others discover it.
      ...
      >
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1.5">
            Tool Name <span className="text-violet-400">*</span>
          </label>
          <input
            type="text"
            name="tool_name"
        ...
        <button
          type="submit"
          className="w-full rounded-xl bg-violet-600 hover:bg-violet-500 px-6 py-3.5 font-semibold text-white transition-colors"
        >

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-password-managers/tools/${tool.slug}` },
  };
}
...
export default async function PasswordManagerToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business Password Managers", item: "https://finderslist.com/business-password-managers" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-password-managers/category/${tool.category}` },

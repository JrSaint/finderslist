...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/online-degree-programs/tools/${tool.slug}` },
  };
}
...
export default async function OnlineDegreeToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Online Degree Programs", item: "https://finderslist.com/online-degree-programs" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/online-degree-programs/category/${tool.category}` },

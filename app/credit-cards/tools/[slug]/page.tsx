...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/credit-cards/tools/${tool.slug}` },
  };
}
...
export default async function CreditCardToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Credit Cards", item: "https://finderslist.com/credit-cards" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/credit-cards/category/${tool.category}` },

      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          {tools.length === 0 ? (
            <div className="text-center py-16 text-slate-500">
              ...
              <Link href="/submit" className="text-violet-400 hover:text-violet-300">Submit one!</Link>
            </div>
          ) : (
          ...
          <div className="mt-10">
            <AdBanner slot="1122334455" format="horizontal" className="h-24 w-full" />
          </div>
        </div>
        ...
        <aside className="lg:w-64 flex-shrink-0">
          <div className="sticky top-24">
            ...
            <div className="mt-6">
              <AdBanner slot="5544332211" format="rectangle" className="h-64 w-full" />
            </div>

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/test-prep-services/tools/${tool.slug}` },
  };
}
...
export default async function TestPrepToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Test Prep Services", item: "https://finderslist.com/test-prep-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/test-prep-services/category/${tool.category}` },

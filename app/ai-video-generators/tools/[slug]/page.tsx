...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ai-video-generators/tools/${tool.slug}` },
  };
}
...
export default async function AIVideoToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "AI Video Generators", item: "https://finderslist.com/ai-video-generators" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ai-video-generators/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/video-conferencing-software/category/${slug}` },
  };
}
...
export default async function VideoConferencingCategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: tools.map((tool, i) => ({
      ...
      url: `https://finderslist.com/video-conferencing-software/tools/${tool.slug}`,
    })),
  };

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/video-conferencing-software/tools/${tool.slug}` },
  };
}
...
export default async function VideoConferencingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Video Conferencing Software", item: "https://finderslist.com/video-conferencing-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/video-conferencing-software/category/${tool.category}` },

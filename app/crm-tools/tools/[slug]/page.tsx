...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/crm-tools/tools/${tool.slug}` },
  };
}
...
export default async function CRMToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "CRM Tools", item: "https://finderslist.com/crm-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/crm-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/gold-ira-companies/tools/${tool.slug}` },
  };
}
...
export default async function GoldIRAToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Gold IRA Companies", item: "https://finderslist.com/gold-ira-companies" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/gold-ira-companies/category/${tool.category}` },

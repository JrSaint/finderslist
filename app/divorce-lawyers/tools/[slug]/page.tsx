...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/divorce-lawyers/tools/${tool.slug}` },
  };
}
...
export default async function DivorceLawyerToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Divorce Lawyers", item: "https://finderslist.com/divorce-lawyers" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/divorce-lawyers/category/${tool.category}` },

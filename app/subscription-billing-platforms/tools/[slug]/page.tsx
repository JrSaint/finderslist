...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/subscription-billing-platforms/tools/${tool.slug}` },
  };
}
...
export default async function SubscriptionBillingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Subscription Billing Platforms", item: "https://finderslist.com/subscription-billing-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/subscription-billing-platforms/category/${tool.category}` },

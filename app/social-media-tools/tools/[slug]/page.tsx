...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/social-media-tools/tools/${tool.slug}` },
  };
}
...
export default async function SocialMediaToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "SocialMedia Tools", item: "https://finderslist.com/social-media-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/social-media-tools/category/${tool.category}` },

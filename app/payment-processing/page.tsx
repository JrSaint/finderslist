  ...
  return (
    <div className="min-h-screen">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <SearchBar large basePath="/payment-processing" />
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AdBanner slot="1234567895" format="horizontal" className="mt-8 h-24 w-full" />
        ...
        {isFiltering ? (
          ...
          <>
            ...
            <div className="mt-12">
              <AdBanner slot="0987654326" format="rectangle" className="h-64 w-full max-w-lg mx-auto" />
            </div>

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/payment-processing/tools/${tool.slug}` },
  };
}
...
export default async function PaymentProcessingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Payment Processing", item: "https://finderslist.com/payment-processing" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/payment-processing/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/cryptocurrency-exchanges/tools/${tool.slug}` },
  };
}
...
export default async function CryptoExchangeToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Cryptocurrency Exchanges", item: "https://finderslist.com/cryptocurrency-exchanges" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/cryptocurrency-exchanges/category/${tool.category}` },

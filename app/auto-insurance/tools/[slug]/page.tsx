...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.finderslist.com/auto-insurance/tools/${tool.slug}` },
  };
}
...
export default async function AutoInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Auto Insurance", item: "https://www.finderslist.com/auto-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://www.finderslist.com/auto-insurance/category/${tool.category}` },

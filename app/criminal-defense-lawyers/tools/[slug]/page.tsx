...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/criminal-defense-lawyers/tools/${tool.slug}` },
  };
}
...
export default async function CriminalDefenseLawyerToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Criminal Defense Lawyers", item: "https://finderslist.com/criminal-defense-lawyers" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/criminal-defense-lawyers/category/${tool.category}` },

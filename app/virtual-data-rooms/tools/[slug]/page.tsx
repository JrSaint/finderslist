...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/virtual-data-rooms/tools/${tool.slug}` },
  };
}
...
export default async function VirtualDataRoomToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Virtual Data Rooms", item: "https://finderslist.com/virtual-data-rooms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/virtual-data-rooms/category/${tool.category}` },

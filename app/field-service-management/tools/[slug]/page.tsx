...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/field-service-management/tools/${tool.slug}` },
  };
}
...
export default async function FieldServiceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Field Service Management", item: "https://finderslist.com/field-service-management" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/field-service-management/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/fleet-management-software/tools/${tool.slug}` },
  };
}
...
export default async function FleetManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Fleet Management Software", item: "https://finderslist.com/fleet-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/fleet-management-software/category/${tool.category}` },

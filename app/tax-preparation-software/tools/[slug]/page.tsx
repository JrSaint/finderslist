...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/tax-preparation-software/tools/${tool.slug}` },
  };
}
...
export default async function TaxPrepToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Tax Preparation Software", item: "https://finderslist.com/tax-preparation-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/tax-preparation-software/category/${tool.category}` },

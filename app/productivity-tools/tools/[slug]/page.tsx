...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/productivity-tools/tools/${tool.slug}` },
  };
}
...
export default async function ProductivityToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Productivity Tools", item: "https://finderslist.com/productivity-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/productivity-tools/category/${tool.category}` },

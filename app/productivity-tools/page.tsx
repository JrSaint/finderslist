...
import { PRODUCTIVITY_EDITORIAL } from "@/data/productivity-tools";
...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  if (isFiltering) {
    return { robots: { index: false, follow: false }, alternates: { canonical: "https://www.finderslist.com/productivity-tools" } };
  }
  return {
    ...
    alternates: { canonical: "https://www.finderslist.com/productivity-tools" },
  };
}
...
export default async function ProductivityToolsPage({ searchParams }: Props) {
  ...
  const itemListJsonLd = {
    ...
    description: "Discover the best productivity tools for teams and individuals. Compare project management software, note-taking apps, time trackers, automation tools, and more — including Monday.com, Notion, Zapier, Slack, and 30+ others.",
  ...
  const faqJsonLd = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: (PRODUCTIVITY_EDITORIAL.faq || []).map((f) => ({
      "@type": "Question",
      name: f.question,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {!isFiltering && (
          <EditorialSection
            title={PRODUCTIVITY_EDITORIAL.title}
            intro={PRODUCTIVITY_EDITORIAL.intro}
            buyerGuide={PRODUCTIVITY_EDITORIAL.buyerGuide}
            faq={PRODUCTIVITY_EDITORIAL.faq}
          />
        )}

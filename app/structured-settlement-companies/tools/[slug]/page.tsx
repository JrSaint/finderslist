...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/structured-settlement-companies/tools/${tool.slug}` },
  };
}
...
export default async function StructuredSettlementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Structured Settlement Companies", item: "https://finderslist.com/structured-settlement-companies" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/structured-settlement-companies/category/${tool.category}` },

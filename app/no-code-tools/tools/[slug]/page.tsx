...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/no-code-tools/tools/${tool.slug}` },
  };
}
...
export default async function NoCodeToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "NoCode Tools", item: "https://finderslist.com/no-code-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/no-code-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/online-tutoring-platforms/tools/${tool.slug}` },
  };
}
...
export default async function OnlineTutoringToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Online Tutoring Platforms", item: "https://finderslist.com/online-tutoring-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/online-tutoring-platforms/category/${tool.category}` },

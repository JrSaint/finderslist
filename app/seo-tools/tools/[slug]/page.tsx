...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/seo-tools/tools/${tool.slug}` },
  };
}
...
export default async function SeoToolToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "SEO Tools", item: "https://finderslist.com/seo-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/seo-tools/category/${tool.category}` },

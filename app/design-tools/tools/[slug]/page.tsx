...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/design-tools/tools/${tool.slug}` },
  };
}
...
export default async function DesignToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Design Tools", item: "https://finderslist.com/design-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/design-tools/category/${tool.category}` },

...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  if (isFiltering) {
    return { robots: { index: false, follow: false }, alternates: { canonical: "https://www.finderslist.com/hr-tools" } };
  }
  return {
    ...
    alternates: { canonical: "https://www.finderslist.com/hr-tools" },
  };
}
...
export default async function HRToolsPage({ searchParams }: Props) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "HR & Recruiting Tools", item: "https://www.finderslist.com/hr-tools" },
    ],
  };
  ...
  const itemListJsonLd = {
    ...
    description: "Discover the best HR software for recruiting, payroll, performance management, onboarding, and learning. Compare Greenhouse, BambooHR, Gusto, Rippling, Lattice, and 30+ more with honest reviews and pricing.",
  ...
  const faqJsonLd = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: (HR_EDITORIAL.faq || []).map((f) => ({
      "@type": "Question",
      name: f.question,
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <SearchBar large basePath="/hr-tools" tools={allTools as never[]} />
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {!isFiltering && (
          <>
          <CategoryAtAGlance tools={allTools as never[]} basePath="/hr-tools" />
          <ComparisonTable
        ...
        <RelatedDirectories currentSlug="hr-tools" />
      </div>
    </div>
  );
}

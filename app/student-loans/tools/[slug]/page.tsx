...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/student-loans/tools/${tool.slug}` },
  };
}
...
export default async function StudentLoanToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Student Loans", item: "https://finderslist.com/student-loans" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/student-loans/category/${tool.category}` },

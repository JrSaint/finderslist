    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        <div className="flex-1 min-w-0">
          ...
          <AdBanner slot="2233445574" format="horizontal" className="h-24 w-full mb-8" />
        ...
        <aside className="lg:w-64 flex-shrink-0">
          <div className="sticky top-24 space-y-4">
            <div className="rounded-xl border border-white/10 bg-slate-900/50 p-4">
              ...
              <a href={visitUrl} target="_blank" rel="noopener noreferrer nofollow" className="block w-full rounded-lg bg-red-600 hover:bg-red-500 px-4 py-2.5 text-sm font-medium text-white transition-colors text-center">Visit {tool.name} →</a>
            ...
            <AdBanner slot="6677889908" format="rectangle" className="h-64 w-full" />
            <div className="rounded-xl border border-white/10 bg-slate-900/50 p-4">

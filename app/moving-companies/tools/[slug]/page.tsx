...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/moving-companies/tools/${tool.slug}` },
  };
}
...
export default async function MovingCompanyToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Moving Companies", item: "https://finderslist.com/moving-companies" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/moving-companies/category/${tool.category}` },

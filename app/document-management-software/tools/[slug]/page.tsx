...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/document-management-software/tools/${tool.slug}` },
  };
}
...
export default async function DocumentManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Document Management Software", item: "https://finderslist.com/document-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/document-management-software/category/${tool.category}` },

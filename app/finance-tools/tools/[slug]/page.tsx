...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/finance-tools/tools/${tool.slug}` },
  };
}
...
export default async function FinanceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Finance Tools", item: "https://finderslist.com/finance-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/finance-tools/category/${tool.category}` },

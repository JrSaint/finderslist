...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-tax-software/tools/${tool.slug}` },
  };
}
...
export default async function BusinessTaxToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business Tax Software", item: "https://finderslist.com/business-tax-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-tax-software/category/${tool.category}` },

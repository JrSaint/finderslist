...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-phone-systems/tools/${tool.slug}` },
  };
}
...
export default async function BusinessPhoneToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business Phone Systems", item: "https://finderslist.com/business-phone-systems" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-phone-systems/category/${tool.category}` },

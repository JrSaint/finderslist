...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/budgeting-apps/tools/${tool.slug}` },
  };
}
...
export default async function BudgetingAppToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Budgeting Apps", item: "https://finderslist.com/budgeting-apps" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/budgeting-apps/category/${tool.category}` },

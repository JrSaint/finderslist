...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/security-tools/tools/${tool.slug}` },
  };
}
...
export default async function SecurityToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Security Tools", item: "https://finderslist.com/security-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/security-tools/category/${tool.category}` },

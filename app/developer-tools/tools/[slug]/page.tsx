...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/developer-tools/tools/${tool.slug}` },
  };
}
...
export default async function DeveloperToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Developer Tools", item: "https://finderslist.com/developer-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/developer-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/home-insurance/tools/${tool.slug}` },
  };
}
...
export default async function HomeInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Home Insurance", item: "https://finderslist.com/home-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/home-insurance/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/mortgage-lenders/tools/${tool.slug}` },
  };
}
...
export default async function MortgageLenderToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Mortgage Lenders", item: "https://finderslist.com/mortgage-lenders" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/mortgage-lenders/category/${tool.category}` },

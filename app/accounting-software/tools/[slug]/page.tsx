...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/accounting-software/tools/${tool.slug}` },
  };
}
...
export default async function AccountingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Accounting Software", item: "https://finderslist.com/accounting-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/accounting-software/category/${tool.category}` },

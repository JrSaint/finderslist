...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/estate-planning-services/tools/${tool.slug}` },
  };
}
...
export default async function EstatePlanningToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Estate Planning Services", item: "https://finderslist.com/estate-planning-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/estate-planning-services/category/${tool.category}` },

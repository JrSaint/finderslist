...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/home-warranty-companies/tools/${tool.slug}` },
  };
}
...
export default async function HomeWarrantyToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Home Warranty Companies", item: "https://finderslist.com/home-warranty-companies" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/home-warranty-companies/category/${tool.category}` },

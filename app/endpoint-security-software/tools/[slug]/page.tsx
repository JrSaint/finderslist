...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/endpoint-security-software/tools/${tool.slug}` },
  };
}
...
export default async function EndpointSecurityToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Endpoint Security Software", item: "https://finderslist.com/endpoint-security-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/endpoint-security-software/category/${tool.category}` },

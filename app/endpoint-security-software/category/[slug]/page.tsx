...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/endpoint-security-software/category/${slug}` },
  };
}
...
export default async function EndpointSecurityCategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: tools.map((tool, i) => ({
      ...
      url: `https://finderslist.com/endpoint-security-software/tools/${tool.slug}`,
    })),
  };

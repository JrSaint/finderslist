...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/email-tools/tools/${tool.slug}` },
  };
}
...
export default async function EmailToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Email Tools", item: "https://finderslist.com/email-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/email-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ecommerce-inventory-software/category/${slug}` },
  };
}
...
export default async function EcommerceInventoryCategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: tools.map((tool, i) => ({
      ...
      url: `https://finderslist.com/ecommerce-inventory-software/tools/${tool.slug}`,
    })),
  };

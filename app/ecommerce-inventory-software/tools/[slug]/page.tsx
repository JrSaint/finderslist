...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ecommerce-inventory-software/tools/${tool.slug}` },
  };
}
...
export default async function EcommerceInventoryToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "E-Commerce Inventory Software", item: "https://finderslist.com/ecommerce-inventory-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ecommerce-inventory-software/category/${tool.category}` },

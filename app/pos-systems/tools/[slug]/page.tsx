...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/pos-systems/tools/${tool.slug}` },
  };
}
...
export default async function POSSystemToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "POS Systems", item: "https://finderslist.com/pos-systems" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/pos-systems/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.finderslist.com/dui-lawyers/tools/${tool.slug}` },
  };
}
...
export default async function DUILawyerToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: category.label, item: `https://www.finderslist.com/dui-lawyers/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/health-insurance/tools/${tool.slug}` },
  };
}
...
export default async function HealthInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Health Insurance", item: "https://finderslist.com/health-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/health-insurance/category/${tool.category}` },

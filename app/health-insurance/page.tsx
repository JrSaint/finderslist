...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  if (isFiltering) {
    return { robots: { index: false, follow: false }, alternates: { canonical: "https://finderslist.com/health-insurance" } };
  }
  return {
    ...
    alternates: { canonical: "https://finderslist.com/health-insurance" },
  };
}

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/inventory-management-software/tools/${tool.slug}` },
  };
}
...
export default async function InventoryManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Inventory Management Software", item: "https://finderslist.com/inventory-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/inventory-management-software/category/${tool.category}` },

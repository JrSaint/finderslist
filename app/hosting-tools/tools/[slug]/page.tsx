...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/hosting-tools/tools/${tool.slug}` },
  };
}
...
export default async function HostingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hosting Tools", item: "https://finderslist.com/hosting-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/hosting-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ecommerce-tools/tools/${tool.slug}` },
  };
}
...
export default async function EcommerceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "E-commerce Tools", item: "https://finderslist.com/ecommerce-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ecommerce-tools/category/${tool.category}` },

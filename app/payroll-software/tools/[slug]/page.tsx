...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/payroll-software/tools/${tool.slug}` },
  };
}
...
export default async function PayrollToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Payroll Software", item: "https://finderslist.com/payroll-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/payroll-software/category/${tool.category}` },

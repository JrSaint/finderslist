...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/elearning-tools/tools/${tool.slug}` },
  };
}
...
export default async function ElearningToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Elearning Tools", item: "https://finderslist.com/elearning-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/elearning-tools/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/travel-insurance/tools/${tool.slug}` },
  };
}
...
export default async function TravelInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Travel Insurance", item: "https://finderslist.com/travel-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/travel-insurance/category/${tool.category}` },

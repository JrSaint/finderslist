...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/credit-repair-services/tools/${tool.slug}` },
  };
}
...
export default async function CreditRepairToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Credit Repair Services", item: "https://finderslist.com/credit-repair-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/credit-repair-services/category/${tool.category}` },

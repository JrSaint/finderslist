...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/cloud-storage-providers/tools/${tool.slug}` },
  };
}
...
export default async function CloudStorageToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Cloud Storage Providers", item: "https://finderslist.com/cloud-storage-providers" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/cloud-storage-providers/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/time-tracking-software/tools/${tool.slug}` },
  };
}
...
export default async function TimeTrackingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Time Tracking Software", item: "https://finderslist.com/time-tracking-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/time-tracking-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/contract-management-software/tools/${tool.slug}` },
  };
}
...
export default async function ContractManagementToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Contract Management Software", item: "https://finderslist.com/contract-management-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/contract-management-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/contract-management-software/category/${slug}` },
  };
}
...
export default async function ContractManagementCategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: tools.map((tool, i) => ({
      ...
      url: `https://finderslist.com/contract-management-software/tools/${tool.slug}`,
    })),
  };

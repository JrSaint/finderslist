...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/workers-comp-insurance/tools/${tool.slug}` },
  };
}
...
export default async function WorkersCompToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Workers Comp Insurance", item: "https://finderslist.com/workers-comp-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/workers-comp-insurance/category/${tool.category}` },

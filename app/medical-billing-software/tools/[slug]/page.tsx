...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/medical-billing-software/tools/${tool.slug}` },
  };
}
...
export default async function MedicalBillingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Medical Billing Software", item: "https://finderslist.com/medical-billing-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/medical-billing-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/hotel-booking-platforms/tools/${tool.slug}` },
  };
}
...
export default async function HotelBookingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hotel Booking Platforms", item: "https://finderslist.com/hotel-booking-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/hotel-booking-platforms/category/${tool.category}` },

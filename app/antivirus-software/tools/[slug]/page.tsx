...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/antivirus-software/tools/${tool.slug}` },
  };
}
...
export default async function AntivirusToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Antivirus Software", item: "https://finderslist.com/antivirus-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/antivirus-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/personal-loans/tools/${tool.slug}` },
  };
}
...
export default async function PersonalLoanToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Personal Loans", item: "https://finderslist.com/personal-loans" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/personal-loans/category/${tool.category}` },

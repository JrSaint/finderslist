...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/robo-advisors/tools/${tool.slug}` },
  };
}
...
export default async function RoboAdvisorToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Robo-Advisors", item: "https://finderslist.com/robo-advisors" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/robo-advisors/category/${tool.category}` },

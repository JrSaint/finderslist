...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/mortgage-lending-software/tools/${tool.slug}` },
  };
}
...
export default async function MortgageLendingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Mortgage & Lending Software", item: "https://finderslist.com/mortgage-lending-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/mortgage-lending-software/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-vpn-software/tools/${tool.slug}` },
  };
}
...
export default async function BusinessVPNToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business VPN Software", item: "https://finderslist.com/business-vpn-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-vpn-software/category/${tool.category}` },

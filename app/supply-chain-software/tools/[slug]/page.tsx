...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/supply-chain-software/tools/${tool.slug}` },
  };
}
...
export default async function SupplyChainToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Supply Chain Software", item: "https://finderslist.com/supply-chain-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/supply-chain-software/category/${tool.category}` },

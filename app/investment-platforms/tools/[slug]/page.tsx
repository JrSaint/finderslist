...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/investment-platforms/tools/${tool.slug}` },
  };
}
...
export default async function InvestmentPlatformToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Investment Platforms", item: "https://finderslist.com/investment-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/investment-platforms/category/${tool.category}` },

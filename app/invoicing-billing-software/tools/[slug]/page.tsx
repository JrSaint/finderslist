...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/invoicing-billing-software/tools/${tool.slug}` },
  };
}
...
export default async function InvoicingToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Invoicing & Billing Software", item: "https://finderslist.com/invoicing-billing-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/invoicing-billing-software/category/${tool.category}` },

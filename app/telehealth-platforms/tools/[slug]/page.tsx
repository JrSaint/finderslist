...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/telehealth-platforms/tools/${tool.slug}` },
  };
}
...
export default async function TelehealthToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Telehealth Platforms", item: "https://finderslist.com/telehealth-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/telehealth-platforms/category/${tool.category}` },

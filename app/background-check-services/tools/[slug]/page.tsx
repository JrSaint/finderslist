...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/background-check-services/tools/${tool.slug}` },
  };
}
...
export default async function BackgroundCheckServiceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Background Check Services", item: "https://finderslist.com/background-check-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/background-check-services/category/${tool.category}` },

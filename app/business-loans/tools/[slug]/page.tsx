...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/business-loans/tools/${tool.slug}` },
  };
}
...
export default async function BusinessLoanToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Business Loans", item: "https://finderslist.com/business-loans" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/business-loans/category/${tool.category}` },

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/analytics-tools/tools/${tool.slug}` },
  };
}
...
export default async function AnalyticsToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Analytics Tools", item: "https://finderslist.com/analytics-tools" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/analytics-tools/category/${tool.category}` },

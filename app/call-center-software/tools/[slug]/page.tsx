...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/call-center-software/tools/${tool.slug}` },
  };
}
...
export default async function CallCenterToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Call Center Software", item: "https://finderslist.com/call-center-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/call-center-software/category/${tool.category}` },

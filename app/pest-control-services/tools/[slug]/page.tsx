...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/pest-control-services/tools/${tool.slug}` },
  };
}
...
export default async function PestControlToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Pest Control Services", item: "https://finderslist.com/pest-control-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/pest-control-services/category/${tool.category}` },

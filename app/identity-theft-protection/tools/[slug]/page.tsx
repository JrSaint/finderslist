...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/identity-theft-protection/tools/${tool.slug}` },
  };
}
...
export default async function IdentityTheftProtectionToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Identity Theft Protection", item: "https://finderslist.com/identity-theft-protection" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/identity-theft-protection/category/${tool.category}` },

  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <SearchBar large basePath="/car-accident-lawyers" tools={allTools as never[]} />
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {!isFiltering && (
          <>
          <CategoryAtAGlance tools={allTools as never[]} basePath="/car-accident-lawyers" />
          <ComparisonTable
        ...
        <RelatedDirectories currentSlug="car-accident-lawyers" />
      </div>
    </div>
  );
}

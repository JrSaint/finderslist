...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/car-accident-lawyers/tools/${tool.slug}` },
  };
}
...
export default async function CarAccidentLawyerToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Car Accident Lawyers", item: "https://finderslist.com/car-accident-lawyers" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/car-accident-lawyers/category/${tool.category}` },

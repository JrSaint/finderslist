...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/erp-software/tools/${tool.slug}` },
  };
}
...
export default async function ERPToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "ERP Software", item: "https://finderslist.com/erp-software" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/erp-software/category/${tool.category}` },

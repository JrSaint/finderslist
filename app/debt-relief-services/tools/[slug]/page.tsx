...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/debt-relief-services/tools/${tool.slug}` },
  };
}
...
export default async function DebtReliefToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Debt Relief Services", item: "https://finderslist.com/debt-relief-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/debt-relief-services/category/${tool.category}` },

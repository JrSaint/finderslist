...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/ai-agent-platforms/tools/${tool.slug}` },
  };
}
...
export default async function AIAgentsToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "AI Agent Platforms", item: "https://finderslist.com/ai-agent-platforms" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/ai-agent-platforms/category/${tool.category}` },

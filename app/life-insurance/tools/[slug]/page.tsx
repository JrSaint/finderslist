...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/life-insurance/tools/${tool.slug}` },
  };
}
...
export default async function LifeInsuranceToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Life Insurance", item: "https://finderslist.com/life-insurance" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/life-insurance/category/${tool.category}` },

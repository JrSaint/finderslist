...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://finderslist.com/llc-formation-services/tools/${tool.slug}` },
  };
}
...
export default async function LLCFormationToolPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "LLC Formation Services", item: "https://finderslist.com/llc-formation-services" },
      { "@type": "ListItem", position: 3, name: category.label, item: `https://finderslist.com/llc-formation-services/category/${tool.category}` },

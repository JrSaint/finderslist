...
export const SOCIAL_MEDIA_TOOLS: SocialMediaTool[] = [
    ...
    domain: "buffer.com",
    pros: ["Clean, simple interface","Generous free plan (3 channels)","Good analytics on all plans","Strong Instagram and TikTok support"],
    cons: ["Less powerful than Hootsuite for teams","No social listening","Limited collaboration on lower plans"],
    ...
    description: "Hootsuite is the most widely used enterprise social media management platform, trusted by over 18 million users and 800 Fortune 500 companies. It offers powerful scheduling, team workflows, social listening, analytics, and campaign management across all major networks. The go-to choice for enterprise social media teams.",
    category: "scheduling-publishing",
    ...
    pros: ["Most feature-rich social media platform","Enterprise team workflows and approvals","Strong analytics and reporting","Social listening included"],
    cons: ["Expensive ($99+/month)","Steep learning curve","No free plan (only trial)"],
    ...
    description: "Later is a social media scheduling platform built specifically for visual content — Instagram, Pinterest, TikTok, and other image-first platforms. Its drag-and-drop visual content calendar, Instagram grid preview, and Linkin.bio feature make it the preferred tool for brands, creators, and marketers focused on visual storytelling.",
    category: "scheduling-publishing",
    ...
    domain: "later.com",
    pros: ["Best Instagram grid planning feature","Drag-and-drop visual calendar","Linkin.bio for Instagram traffic","TikTok auto-publishing"],
    cons: ["Less powerful for text-heavy platforms","Free plan is very limited","Analytics not as deep as competitors"],
    ...
    description: "Sprout Social is a premium social media management platform that combines publishing, analytics, social listening, employee advocacy, and customer care in one platform. Known for its best-in-class analytics and reporting, it's the choice for brands that need deep insights and team collaboration.",
    category: "scheduling-publishing",
    ...
    pros: ["Best-in-class analytics and reporting","Strong social CRM and customer care","Excellent team collaboration","Comprehensive social listening"],
    cons: ["Very expensive ($199+/month)","No free plan","Overkill for small teams"],
    ...
    description: "Metricool is an all-in-one social media analytics, scheduling, and reporting platform popular in the agency and creator world for its depth of analytics at an accessible price. It supports more platforms than most competitors (including Twitch and YouTube), offers competitor analysis, and provides beautiful auto-generated reports.",
    category: "scheduling-publishing",
    ...
    pros: ["Supports widest range of platforms","Excellent competitor benchmarking","Beautiful auto-generated reports","Generous free plan"],
    cons: ["UI is less polished than Buffer","Some features require paid plans","Mobile app is basic"],
  ...
  },
  {
    ...
    description: "Mention is a social listening and media monitoring tool that tracks brand mentions across social media, news sites, blogs, and forums in real-time. As of mid-2025 it retired its self-serve Solo and Pro tiers, moving upmarket to a single Company Plan aimed at marketing teams and agencies that need brand reputation and competitor monitoring at scale.",
    category: "social-listening",
    ...
    domain: "mention.com",
    pros: ["Real-time mention alerts","Social and web monitoring combined","Competitive comparison features","Boolean query builder for precise tracking"],
    cons: ["Less data depth than Brandwatch","No free or self-serve plans (Company Plan only)","Historical data access limited"],
  ...
  },
  {
    ...
    description: "Canva is the go-to design tool for social media content creation, with thousands of platform-specific templates for Instagram posts and Reels, Facebook covers, LinkedIn banners, TikTok videos, and more. With AI design tools, a massive asset library, and a content planner, it's become the complete creative hub for social media marketers.",
    ...
    domain: "canva.com",
    pros: ["Thousands of social media templates","Easy to use for non-designers","AI design generation tools","Generous free plan"],
    cons: ["Pro required for best features","Can produce generic-looking designs","Limited animation capabilities vs professional tools"],
    ...
    domain: "adobe.com",
    pros: ["Adobe quality at accessible price","Access to Adobe Stock assets","AI-powered Generative Fill","Free plan available"],
    cons: ["Less templates than Canva","Best value with full Adobe subscription","Less social media-specific than Canva"],
    ...
    description: "Grum was a simple desktop Instagram scheduling tool for direct publishing of posts, carousels, and Reels without needing your phone. Its core scheduling service was discontinued in 2024 and has not returned; only a handful of free AI mini-tools remain on the site today.",
    category: "scheduling-publishing",
    ...
    domain: "grum.co",
    pros: ["True direct Instagram publishing","No push notification needed","Simple and focused","Supports carousels and Reels"],
    cons: ["Instagram-only","Limited analytics","Basic feature set"],
  ...
  },
  {
    ...
    description: "Social Blade is a free social media statistics and analytics website that tracks the growth of YouTube channels, Twitch streamers, Twitter accounts, Instagram profiles, and more. Used by marketers, creators, and brands to research influencer growth, compare accounts, and track social media trends.",
    ...
    pros: ["Free to use for basic stats","Tracks YouTube, Twitch, Instagram, and more","Good for influencer research","Historical growth data"],
    cons: ["Data accuracy can vary","Interface is basic and dated","Advanced features require paid plan"],
  ...
  },
  {
    ...
    domain: "publer.io",
    pros: ["Supports 15+ platforms including Google Business","AI writing assistance","Bulk scheduling from CSV or RSS","Affordable for agencies"],
    cons: ["Less polished UI than Buffer","Analytics are basic","Some platform integrations are flaky"],
    ...
    description: "Planoly is a visual social media planner specifically designed for Instagram and Pinterest. Its grid planning feature allows creators and brands to see exactly how their Instagram feed will look before posting. Includes a linkin.bio feature, TikTok scheduling, and analytics.",
    category: "scheduling-publishing",
    ...
    domain: "planoly.com",
    pros: ["Best-in-class Instagram grid preview","Beautiful visual planning interface","Pinterest direct scheduling","Storefront feature for creators"],
    cons: ["Primarily Instagram and Pinterest focused","Analytics are limited","Free plan allows 30 posts/month"],

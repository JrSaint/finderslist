...
export const ELEARNING_TOOLS: ElearningTool[] = [
    ...
    pros: ["Easy to use for non-technical creators","Built-in payment processing","Good student management tools","No transaction fees on Builder plan and up"],
    cons: ["Transaction fees on lower plans","Limited community features","Less customizable than Kajabi"],
    ...
    domain: "kajabi.com",
    pros: ["All-in-one — no need for extra tools","Beautiful product delivery","Built-in email marketing","No transaction fees"],
    cons: ["Expensive ($179+/mo)","Overkill for beginners","Community features lag behind Circle"],
    ...
    description: "Thinkific is a popular course creation platform known for its strong free plan, flexible course builder, and no transaction fees. It's used by over 50,000 creators worldwide for courses, memberships, and communities. A good middle-ground between Teachable's simplicity and Kajabi's power.",
    category: "course-creation",
    ...
    pros: ["No transaction fees on any plan","14-day free trial on all plans","Flexible course builder","Good community features (Thinkific Communities)"],
    cons: ["Less all-in-one than Kajabi","Email marketing requires integration","Design customization is limited"],
    ...
    description: "Podia is an all-in-one platform for creators to sell online courses, digital downloads, webinars, and memberships. It bundles email marketing and community tools in a clean, simple interface at an affordable price. Its free plan was retired in favor of paid plans with a 30-day trial, and the entry Mover plan now carries a 5% transaction fee.",
    category: "course-creation",
    ...
    domain: "podia.com",
    pros: ["Simple and beginner-friendly","No transaction fees on the Shaker plan","Includes email marketing","Affordable pricing"],
    cons: ["Less powerful than Kajabi","Community features are basic","Limited course design customization"],
  ...
  },
  {
    ...
    {
    slug: "lessonly",
    name: "Seismic Learning (formerly Lessonly)",
    tagline: "Work better training software for teams",
    description: "Lessonly (now part of Seismic) is a training and enablement platform designed for customer-facing teams — sales, support, and customer success. It offers simple lesson creation, practice scenarios, and coaching tools. Widely used by sales and support organizations for onboarding and skills development.",
    category: "employee-training",
    ...
    domain: "seismic.com",
    pros: ["Purpose-built for customer-facing teams","Practice scenarios and role-play","Easy lesson creation","Good manager coaching tools"],
    cons: ["Expensive","Less suited for technical or compliance training","Best value only with full Seismic suite"],
  ...
  },
  {
    ...
    {
    slug: "edapp",
    name: "SC Training (formerly EdApp)",
    tagline: "The free microlearning platform for frontline teams",
    description: "EdApp was a mobile-first microlearning platform for frontline and deskless workers. Acquired by SafetyCulture and rebranded as SC Training in 2024, the platform was retired on March 31, 2026, with customers directed to migrate their content, user data, and completion records to other tools. Its authoring suite, spaced-repetition algorithms, and gamification once made it popular across retail, hospitality, and manufacturing.",
    ...
    domain: "training.safetyculture.com",
    pros: ["Free for unlimited users","Mobile-first, ideal for frontline workers","Beautiful interactive lessons","Spaced repetition for retention"],
    cons: ["Less suitable for complex, long-form training","Limited reporting on free plan","Some advanced features require paid plan"],
  ...
  },
  {
    ...
    description: "Articulate 360 is the most widely used e-learning authoring suite in corporate L&D, featuring Storyline 360 for interactive course creation and Rise 360 for responsive, beautiful courses that work on any device. Used by instructional designers at companies worldwide to create SCORM-compliant training.",
    category: "employee-training",
    ...
    pros: ["Industry standard — every ID knows Storyline","Rise 360 for fast, beautiful responsive courses","SCORM and xAPI export","Huge community and template library"],
    cons: ["$1,449+/year subscription","Storyline has a steep learning curve","Windows-only for Storyline (Rise is web-based)"],
    useCases: ["Corporate e-learning development","Compliance courses","Interactive simulations","L&D teams"],
    startingPrice: "$1,449/yr",
    priceCurrency: "USD",
    lastReviewed: "2026-06-16",
  },
  {

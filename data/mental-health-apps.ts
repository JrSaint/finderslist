...
export const MENTAL_HEALTH_CATEGORIES: Record<MentalHealthCategory, { label: string; emoji: string; description: string; gradient: string; guide?: string }> = {
  "therapy-counseling": { label: "Therapy & Counseling", emoji: "🛋️", description: "Connect with licensed therapists for professional counseling and talk therapy.", gradient: "from-violet-600/30 to-purple-800/40", guide: "Therapy and counseling platforms connect you with licensed mental health professionals for video, phone, or text-based sessions. They are best for individuals seeking professional support for anxiety, depression, relationship issues, or other mental health concerns. Look for platforms that verify therapist credentials, accept your insurance, and make it easy to switch providers if the fit is not right." },
  "meditation-mindfulness": { label: "Meditation & Mindfulness", emoji: "🧘", description: "Guided meditation, breathing exercises, and mindfulness practices for daily wellness.", gradient: "from-teal-600/30 to-emerald-800/40", guide: "Meditation and mindfulness apps offer guided sessions, breathing exercises, and relaxation techniques to reduce stress and improve daily well-being. They are ideal for anyone looking to build a consistent mindfulness practice, from beginners to experienced meditators. Prioritize apps with structured programs, sleep content, and progress tracking that keeps you motivated over time." },
  "mood-tracking": { label: "Mood Tracking", emoji: "📊", description: "Track emotions, identify patterns, and build self-awareness with daily check-ins.", gradient: "from-blue-600/30 to-indigo-800/40", guide: "Mood tracking apps help you log daily emotions, identify triggers, and recognize patterns in your mental health over time. They are best for individuals who want to build self-awareness or share insights with their therapist. Look for apps with quick check-in workflows, journaling features, and visualizations that reveal trends in your emotional well-being." },
  "substance-recovery": { label: "Substance Recovery", emoji: "🌱", description: "Support tools for addiction recovery, sobriety tracking, and substance abuse treatment.", gradient: "from-amber-600/30 to-orange-800/40", guide: "Substance recovery apps provide sobriety tracking, peer support communities, and evidence-based tools for managing addiction and maintaining recovery. They are designed for individuals in any stage of recovery who need daily accountability and motivation. Look for apps with milestone tracking, crisis support resources, and connections to professional treatment when needed." },
  "crisis-support": { label: "Crisis Support", emoji: "🆘", description: "Immediate access to crisis counselors and mental health support during emergencies.", gradient: "from-red-600/30 to-rose-800/40", guide: "Crisis support apps provide immediate access to trained counselors, safety planning tools, and emergency resources during mental health crises. They are critical for individuals experiencing suicidal thoughts, severe anxiety attacks, or acute emotional distress. Look for apps with 24/7 availability, direct hotline connections, and safety plan features that you can set up in advance." },
};

...
export const FITNESS_APP_CATEGORIES: Record<FitnessAppCategory, { label: string; emoji: string; description: string; gradient: string; guide?: string }> = {
  "workout-training": { label: "Workout & Training", emoji: "💪", description: "Structured workout programs, strength training plans, and guided exercise routines.", gradient: "from-red-600/30 to-orange-800/40", guide: "Workout and training apps provide structured exercise programs with progressive overload, video demonstrations, and rep tracking. They are best for gym-goers and home exercisers who want guided strength training, HIIT, or bodyweight routines. Look for customizable programs, rest timers, and the ability to log and track your lifts over time." },
  "running-cardio": { label: "Running & Cardio", emoji: "🏃", description: "GPS tracking, training plans, and social features for runners and cyclists.", gradient: "from-blue-600/30 to-indigo-800/40", guide: "Running and cardio apps use GPS to track your routes, pace, distance, and elevation while providing structured training plans for races from 5K to marathon. They are ideal for runners, cyclists, and outdoor fitness enthusiasts who want data-driven coaching. Prioritize apps with accurate GPS tracking, interval training support, and social features to stay motivated." },
  "yoga-flexibility": { label: "Yoga & Flexibility", emoji: "🧘", description: "Yoga classes, stretching routines, and flexibility programs for all levels.", gradient: "from-teal-600/30 to-emerald-800/40", guide: "Yoga and flexibility apps offer guided classes ranging from beginner flows to advanced practices, with video instruction and curated programs. They are best for practitioners who want studio-quality yoga at home on their own schedule. Look for variety in class length and style, qualified instructors, and options for meditation and breathwork." },
  "nutrition-diet": { label: "Nutrition & Diet", emoji: "🥗", description: "Calorie tracking, macro counting, meal planning, and nutritional guidance.", gradient: "from-green-600/30 to-lime-800/40", guide: "Nutrition and diet apps help you log meals, track calories and macronutrients, scan barcodes, and build meal plans aligned with your health goals. They are ideal for anyone pursuing weight loss, muscle gain, or specific dietary protocols. Look for a large food database, barcode scanning accuracy, and integration with fitness trackers for net calorie calculations." },
  "wearable-connected": { label: "Wearable Connected", emoji: "⌚", description: "Fitness platforms that sync with wearable devices for comprehensive health tracking.", gradient: "from-violet-600/30 to-purple-800/40", guide: "Wearable-connected fitness platforms sync with smartwatches and fitness bands to provide a comprehensive view of activity, sleep, heart rate, and recovery. They are best for users who want passive all-day health monitoring alongside active workout tracking. Look for broad device compatibility, actionable health insights, and meaningful trend analysis over time." },
};

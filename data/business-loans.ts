...
export const BUSINESS_LOAN_CATEGORIES: Record<BusinessLoanCategory, { label: string; emoji: string; description: string; gradient: string; guide?: string }> = {
  "term-loan": { label: "Term Loans", emoji: "💵", description: "Fixed lump-sum loans repaid over a set period, ideal for large one-time investments and expansions.", gradient: "from-green-600/30 to-emerald-800/40", guide: "Term loans provide a lump sum of capital repaid in fixed installments over a set period, making them ideal for one-time investments like expansion, renovation, acquisition, or large equipment purchases. They suit established businesses with predictable revenue that can commit to a regular repayment schedule. Compare the total cost of the loan including origination fees and prepayment penalties, and be cautious of online lenders quoting factor rates instead of APR, which can obscure the true cost of borrowing." },
  "sba": { label: "SBA Loans", emoji: "🏛️", description: "Government-backed Small Business Administration loans offering low rates and long repayment terms.", gradient: "from-blue-600/30 to-indigo-800/40", guide: "SBA loans are partially guaranteed by the federal government, allowing lenders to offer lower interest rates and longer repayment terms than conventional business loans, with the SBA 7(a) program being the most versatile option. They are best for established businesses with strong credit that can wait four to twelve weeks for funding in exchange for the most favorable terms available. Be prepared with thorough documentation including tax returns, financial statements, and a business plan, as the application process is significantly more involved than online lending alternatives." },
  "line-of-credit": { label: "Lines of Credit", emoji: "🔄", description: "Flexible revolving credit that lets businesses draw funds as needed and repay on their own schedule.", gradient: "from-purple-600/30 to-violet-800/40", guide: "Business lines of credit provide revolving access to capital that you can draw from and repay as needed, only paying interest on the amount you actually use. They are the best financing option for managing cash flow gaps, covering seasonal fluctuations, or having emergency funds available without committing to a fixed loan. Compare draw fees, maintenance fees, and whether the credit line requires annual renewal, and understand the difference between secured and unsecured lines, as secured options offer higher limits and lower rates." },
  "equipment": { label: "Equipment Financing", emoji: "⚙️", description: "Loans and leases specifically for purchasing business equipment, machinery, and technology.", gradient: "from-orange-600/30 to-red-800/40", guide: "Equipment financing uses the purchased equipment itself as collateral, making it easier to qualify for than unsecured loans and typically offering lower rates since the lender's risk is reduced. It is ideal for businesses that need expensive machinery, vehicles, technology, or specialized tools but want to preserve working capital. Decide between a loan where you own the equipment outright and a lease that offers lower payments but may cost more long-term, and check whether the financing terms align with the useful life of the equipment to avoid paying for something that is already outdated." },
  "invoice-financing": { label: "Invoice Financing", emoji: "🧾", description: "Advance funding against outstanding invoices to improve cash flow without waiting for customer payments.", gradient: "from-yellow-600/30 to-amber-800/40", guide: "Invoice financing advances you cash against your outstanding invoices, typically 80-90% of the invoice value upfront, so you can cover expenses without waiting 30, 60, or 90 days for customers to pay. It is best for B2B businesses with creditworthy clients and long payment terms that create cash flow gaps. Compare the advance rate, factor fee structure, and whether the provider uses recourse or non-recourse factoring, as non-recourse means the financing company absorbs the loss if your customer does not pay." },
};

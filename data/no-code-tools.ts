...
export const NO_CODE_TOOLS: NoCodeTool[] = [
  ...
  },
  {
    ...
    description: "Adalo is a no-code app builder focused on creating native mobile apps for iOS and Android, as well as web apps. It features a component library, built-in database, and direct publishing to the App Store and Google Play. Popular with entrepreneurs and small teams who want to launch mobile apps without a developer.",
    category: "app-builders",
    ...
    domain: "adalo.com",
    pros: ["Build and publish native mobile apps","Publish to App Store and Google Play","Component-based design","Good for simple mobile apps"],
    cons: ["Performance can be slow","Limited complex logic","More expensive than web-only builders"],
  ...
  },
  {
    ...
    description: "n8n is an open-source, self-hostable workflow automation tool that gives developers the power of Zapier or Make with full control over their data and infrastructure. It supports 400+ integrations and allows custom JavaScript code nodes for any logic. The go-to choice for technical teams who want no-code automation without vendor lock-in.",
    category: "automation",
    ...
    domain: "n8n.io",
    pros: ["Open source and self-hostable","JavaScript code nodes for custom logic","No execution limits when self-hosted","Fair-code license"],
    cons: ["Requires technical setup for self-hosting","Fewer integrations than Zapier","Less user-friendly for non-technical users"],
  ...
  },
  {
    ...
    description: "Webflow Logic was Webflow's built-in no-code workflow automation tool for adding conditional logic, form triggers, and integrations directly within Webflow. Webflow sunset Logic on June 27, 2025 — existing flows are disabled and no new flows can be created, and the companion User Accounts feature was disabled in January 2026. Webflow now directs users to partner automation apps like Zapier and Make for form routing, CRM updates, and email triggers.",
    category: "automation",
    ...
    domain: "webflow.com",
    pros: ["Native Webflow integration — no Zapier needed","Simple form workflow automation","Good for Webflow-based businesses"],
    cons: ["Only works within Webflow ecosystem","Less powerful than dedicated automation tools","Still maturing"],
    ...
    description: "Pabbly Connect is a workflow automation platform that offers unlimited workflows, unlimited automation tasks, and a one-time payment option — making it dramatically cheaper than Zapier or Make for high-volume automations. Supports 1,000+ apps and is popular with budget-conscious businesses and agencies.",
    category: "automation",
    ...
    domain: "pabbly.com",
    pros: ["One-time lifetime payment option","Unlimited workflows and tasks","Good for high-volume automation","Affordable vs Zapier"],
    cons: ["Less polished than Zapier","Fewer app integrations","Slower development pace"],

...
export const EMAIL_TOOLS: EmailTool[] = [
    ...
    description: "Klaviyo is the leading email and SMS marketing platform for e-commerce brands, used by over 130,000 businesses. It integrates deeply with Shopify, BigCommerce, and WooCommerce to power data-driven automation flows — abandoned cart sequences, post-purchase follow-ups, browse abandonment, and more. The standard for DTC e-commerce marketing.",
    ...
    domain: "klaviyo.com",
    pros: ["Best-in-class e-commerce data integration","Powerful abandoned cart and flow automation","Strong segmentation based on purchase behavior","SMS and email in one platform"],
    cons: ["Expensive as list size grows","Learning curve for non-marketers","Best value only with Shopify"],
    ...
    description: "Mailchimp is the world's most popular email marketing platform with over 13 million users. It's the go-to starting point for small businesses and entrepreneurs, offering email marketing, automation, landing pages, and CRM in one tool. Known for its user-friendly interface and generous free plan.",
    category: "email-marketing",
    ...
    pros: ["Easiest email tool for beginners","Free up to 500 contacts","Good template library","All-in-one with CRM and landing pages"],
    cons: ["Expensive as list grows","Automation is less powerful than Klaviyo","Removed free plan features over time"],
    ...
    description: "ActiveCampaign is a powerful email marketing and marketing automation platform that combines email, SMS, CRM, and sales automation in one tool. Known for its advanced automation builder and deep customer journey capabilities, it's used by over 185,000 businesses who need more power than Mailchimp.",
    category: "email-marketing",
    ...
    pros: ["Most powerful automation builder in class","CRM and email in one platform","Advanced conditional logic in automations","Good B2B and B2C versatility"],
    cons: ["No free plan (only 14-day trial)","Can be overwhelming to start","Expensive at scale"],
    ...
    domain: "kit.com",
    pros: ["Best email tool for creators and bloggers","Free up to 10,000 subscribers","Clean, distraction-free editor","Built-in paid newsletter (commerce) features"],
    cons: ["Less powerful for e-commerce","Limited landing page templates","Not ideal for complex B2B automation"],
    ...
    domain: "drip.com",
    pros: ["Strong e-commerce segmentation","Product recommendation features","Good visual automation builder","Email and SMS combined"],
    cons: ["Expensive vs Klaviyo for similar features","Less popular = smaller community","No free plan"],
    ...
    domain: "sendgrid.com",
    pros: ["Industry-leading deliverability","Powerful API with extensive documentation","Free 100 emails/day","Email analytics and tracking"],
    cons: ["Support can be slow on free plans","Marketing email product is basic","Account suspension issues have been reported"],
    ...
    description: "Postmark is a premium transactional email service that prioritizes speed and deliverability above all else. It's used by developers and SaaS companies who need password reset emails and notifications to arrive within seconds, not minutes. Postmark has a strict acceptable use policy that keeps its sending reputation pristine.",
    category: "transactional-email",
    ...
    pros: ["Fastest inbox delivery times","Excellent deliverability reputation","Clean, developer-friendly API","60-day email activity retention"],
    cons: ["More expensive than SendGrid","No free tier","Strict acceptable use policy can affect edge cases"],
    ...
    description: "Resend is a modern email API built by developers, for developers. It features a clean REST API, React Email support for building email templates as React components, and excellent developer experience. Growing rapidly as the modern alternative to SendGrid for developer-first teams.",
    category: "transactional-email",
    ...
    domain: "resend.com",
    pros: ["Best developer experience in class","React Email for component-based templates","100 emails/day free","Modern, clean API design"],
    cons: ["Newer — less battle-tested than SendGrid","Fewer advanced marketing features","Smaller ecosystem"],
    ...
    description: "Mailgun is a developer-focused email delivery API from Sinch, used by thousands of businesses for sending, receiving, and tracking emails. It offers a powerful API, email validation, inbox placement testing, and excellent documentation. A strong alternative to SendGrid for teams that want granular control.",
    category: "transactional-email",
    ...
    domain: "mailgun.com",
    pros: ["Excellent email validation API","Inbox placement testing tools","Good documentation","EU data center available"],
    cons: ["Support is slow on lower plans","Dashboard UI feels dated","Price-per-email adds up quickly"],
    ...
    description: "Instantly is a fast-growing cold email platform that lets users connect unlimited sending accounts, warm them up automatically, and run AI-personalized cold email campaigns at scale. Known for its aggressive deliverability features and aggressive pricing, it's become popular with sales teams and growth hackers.",
    category: "cold-email",
    ...
    domain: "instantly.ai",
    pros: ["Unlimited sending accounts on all plans","Built-in email warm-up","AI personalization at scale","Strong deliverability features"],
    cons: ["Focused on volume — not quality","Cold email carries compliance risks","Lead list quality still matters"],
    ...
    domain: "lemlist.com",
    pros: ["Best image and video personalization","True multi-channel (email + LinkedIn + calls)","Strong reply rate improvements","Active community and education resources"],
    cons: ["More expensive than volume-focused tools","Personalization setup takes time","Cold email compliance still required"],
    ...
    description: "Apollo.io combines a B2B lead database of 275M+ contacts with a powerful sales engagement platform for cold email and multi-channel outreach. Its unique value: find, enrich, and contact leads all in one tool. Used by over 1 million salespeople for prospecting, sequencing, and pipeline building.",
    category: "cold-email",
    ...
    domain: "apollo.io",
    pros: ["275M+ contact database","All-in-one: find leads + send sequences","Free tier available","Strong CRM integrations"],
    cons: ["Data quality varies","Cold email compliance still required","Free plan is limited"],
    ...
    domain: "beehiiv.com",
    pros: ["Best newsletter monetization ecosystem","Built-in ad network for income","Referral program for growth","Superior analytics"],
    cons: ["Free plan limited to 2,500 subscribers","Less name recognition than Substack","Limited design customization vs Ghost"],
    ...
    domain: "substack.com",
    pros: ["Free to start, no monthly fees","Built-in reader network and discovery","Simple to use","Podcast and video support"],
    cons: ["10% revenue cut on paid subscriptions","Less analytics than beehiiv","Limited growth tools compared to competitors"],
  ...
  },
  {
    ...
    description: "Email on Acid is an email testing platform that previews how your email renders across 100+ email clients and devices — Gmail, Outlook, Apple Mail, and more — with deliverability checks, accessibility testing, and spam filter testing. Now owned by Sinch, it is being folded into the new Mailgun Inspect product, with existing-customer migration beginning in 2026.",
    ...
    pros: ["Preview across 100+ clients","Deliverability and spam score testing","Accessibility checker","Used by enterprise email teams"],
    cons: ["Expensive subscription","Some previews can take minutes","Focused on testing only — no sending"],
    ...
    description: "Litmus is the premium email optimization platform used by major brands and agencies to test, personalize, analyze, and optimize email campaigns before sending. It includes email previews, spam testing, email analytics beyond open rates, and a collaborative review workflow. The enterprise standard for email quality assurance.",
    category: "email-testing",
    ...
    domain: "litmus.com",
    pros: ["Enterprise email QA standard","Deep email analytics beyond opens","Collaboration and approval workflows","Spam filter testing across ISPs"],
    cons: ["Expensive (entry Core plan starts at $500/mo)","Overkill for small senders","Some previews require full plan"],

...
export const BUDGETING_APP_TOOLS: BudgetingAppTool[] = [
  // ── ENVELOPE BUDGETING ──────────────────────────────────────────────────
    ...
    logo: "💰",
    domain: "ynab.com",
    pros: ["Proven four-rule methodology changes spending behavior long-term","Real-time bank sync with manual entry option for accuracy","Age-of-money metric shows how far ahead you are financially","Excellent goal-tracking for vacations, emergencies, and large purchases","Active community with free workshops and educational content"],
    cons: ["Annual subscription of $99/year may deter budget-conscious beginners","Learning curve is steeper than most automated tracking apps","No investment tracking or net worth beyond linked accounts","Mobile app can feel clunky for complex budget adjustments"],
    useCases: ["Set up category goals to save $5,000 for an emergency fund over six months","Use the age-of-money metric to stop living paycheck-to-paycheck within 90 days","Roll with the punches by reallocating overspent dining-out dollars from clothing"],
    startingPrice: "$109/yr",
    priceCurrency: "USD",
  ...
  },
  {
    ...
    slug: "mvelopes",
    name: "Mvelopes",
    tagline: "Discontinued — Mvelopes shut down on December 29, 2022",
    description: "Mvelopes, a pioneering digital envelope-budgeting app, permanently shut down on December 29, 2022 after 21 years of operation. Former subscribers were offered a discounted transfer to EveryDollar. For envelope-style budgeting today, consider Goodbudget, YNAB, or EveryDollar.",
    category: "envelope-budgeting",
  ...
  // ── AUTOMATED TRACKING ──────────────────────────────────────────────────
    ...
    cons: ["Transitioning to Credit Karma, future feature set uncertain","Ad-supported model means frequent credit card and loan offers","Categorization accuracy requires regular manual corrections","Limited budgeting methodology compared to zero-based alternatives"],
    useCases: ["Link all bank and credit accounts to see total spending breakdown by category each month","Set bill reminders to avoid late payment fees on utilities and subscriptions","Monitor your credit score monthly without signing up for a separate service"],
    status: "shutdown",
    lastReviewed: "2026-06-05",
  },
    {
    ...
    pros: ["Beautiful, modern interface with no ads or upsell clutter","Combines budgeting, investments, and net worth in one platform","Collaborative features let partners manage finances together","Reliable account syncing with fast transaction updates","Flexible budgeting that adapts to rollover and custom categories"],
    cons: ["$14.99/month or $99.99/year subscription with no free tier","Newer platform with a smaller community than established alternatives","Limited integrations outside of financial account syncing"],
    useCases: ["Track household net worth across bank accounts, 401(k)s, and real estate in one dashboard","Set up a joint budget with your partner where both can categorize and review transactions","Analyze recurring subscriptions to identify services you can cancel and save $200/month"],
    startingPrice: "$99.99/yr",
    priceCurrency: "USD",
    lastReviewed: "2026-06-05",
  },
  {

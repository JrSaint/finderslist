...
export const ANALYTICS_TOOLS: AnalyticsTool[] = [
  {
    ...
    domain: "plausible.io",
    pros: ["Privacy-friendly — no cookies needed","GDPR compliant out of the box","Clean, simple dashboard","Lightweight script (< 1KB)"],
    cons: ["No free plan (only 30-day trial)","Less deep than GA4 for advanced analysis","No Google Ads integration"],
    ...
    description: "Fathom Analytics is a privacy-focused web analytics platform that's GDPR, CCPA, and PECR compliant. Like Plausible, it collects no personal data and uses no cookies. It stands out for its fast-loading script, simple pricing, and a strong focus on customer privacy and data sovereignty.",
    category: "web-analytics",
    ...
    pros: ["Strong privacy compliance (GDPR, CCPA, PECR)","Ultra-lightweight script","Simple, focused dashboard","Great customer support"],
    cons: ["No free plan","Less data detail than GA4","Smaller feature set by design"],
    ...
    description: "Mixpanel is one of the most powerful product analytics platforms, designed to help teams understand user behavior at a granular level. It excels at funnel analysis, retention reports, A/B testing, and segmentation. Used by product and growth teams at leading tech companies to make data-driven decisions.",
    ...
    domain: "mixpanel.com",
    pros: ["Industry-leading funnel and retention analysis","Powerful segmentation","Free tier up to 1M events/month","Strong SQL-based querying (JQL)"],
    cons: ["Expensive at scale","Requires good event tracking implementation","Steeper learning curve"],
  ...
  },
  {
    ...
    description: "Heap is a product analytics platform that automatically captures every user interaction on your site or app — clicks, taps, form submissions, page views — without any manual event instrumentation. Teams can then retroactively analyze any behavior without needing to re-instrument. Acquired by Contentsquare.",
    category: "product-analytics",
    ...
    domain: "heap.io",
    pros: ["Autocapture — no manual event tracking","Retroactive analysis of any behavior","Strong funnel analysis","Good for early-stage products"],
    cons: ["Expensive at scale","Large data volumes can slow queries","Less powerful segmentation than Amplitude"],
  ...
  },
  {
    ...
    description: "Tableau is the world's most widely used business intelligence and data visualization platform. It connects to hundreds of data sources and lets analysts create interactive dashboards and reports without SQL or programming. Used by enterprises worldwide for self-service analytics and executive reporting.",
    ...
    domain: "tableau.com",
    pros: ["Most powerful data visualization","Connects to 100+ data sources","Excellent for executive dashboards","Strong community and resource library"],
    cons: ["Expensive ($75+/user/month)","Steep learning curve","Best value with Salesforce ecosystem"],
  ...
  },
  {
    ...
    description: "Power BI is Microsoft's business intelligence platform, deeply integrated into the Microsoft 365 ecosystem. It allows anyone to connect data, create beautiful dashboards, and share insights across the organization. The most affordable enterprise BI option when using Microsoft tools.",
    category: "bi-dashboards",
    ...
    pros: ["Best Microsoft ecosystem integration","Affordable ($14/user/month for Pro)","Powerful with Azure and Excel","Free desktop version available"],
    cons: ["Sharing requires paid licenses","Steeper curve for non-Microsoft users","Performance can lag with large datasets"],
  ...
  },
  {
    ...
    description: "Semrush is the most comprehensive SEO analytics platform, offering keyword research, rank tracking, backlink analysis, site audits, competitive intelligence, and content marketing tools in one platform. Used by over 10 million marketing professionals, it's the go-to platform for SEO agencies and in-house SEO teams.",
    ...
    domain: "semrush.com",
    pros: ["Most comprehensive SEO toolset","Best competitive intelligence data","Content marketing and PPC tools","Free tier available"],
    cons: ["Expensive ($139.95+/month)","Overwhelming for beginners","Some data can be inaccurate"],
    ...
    description: "Ahrefs is arguably the most trusted SEO tool for backlink analysis, with the industry's largest live backlink index. It also offers best-in-class keyword research, rank tracking, content explorer, and site audit tools. Preferred by many SEO professionals over Semrush for its backlink data accuracy and research features.",
    category: "seo-analytics",
    ...
    domain: "ahrefs.com",
    pros: ["Best backlink data in the industry","Excellent keyword research tool","Content Explorer for content ideation","Trusted by top SEO professionals"],
    cons: ["Full features require Lite ($129/mo) or higher","No free plan (only limited free tools)","Less PPC/social data than Semrush"],

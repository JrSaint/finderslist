...
export const APPOINTMENT_SCHEDULING_TOOLS: AppointmentSchedulingTool[] = [
    ...
    logo: "📅",
    domain: "calendly.com",
    pros: ["Extremely intuitive interface with minimal learning curve","Robust integrations with CRMs, video conferencing, and payment tools","Team scheduling features like round-robin and collective availability","Automated reminders and follow-up workflows reduce no-shows","Free tier is generous enough for solo professionals"],
    cons: ["Advanced features like routing forms require expensive plans","Limited customization of the booking page design","No built-in video conferencing — relies on third-party integrations","Can feel impersonal for client-facing service businesses"],
    useCases: ["Sales teams automating discovery call scheduling with prospects","Consultants sharing booking links to simplify client meetings","Recruiters coordinating interview panels with multiple stakeholders"],
    startingPrice: "$10/mo",
    priceCurrency: "USD",
    ...
    pros: ["Highly customizable booking forms with conditional logic","Built-in payment processing through Stripe, Square, and PayPal","Supports packages, memberships, subscriptions, and gift certificates","Advanced availability rules including buffer times and daily limits","Embeddable scheduling widget for any website"],
    cons: ["Interface feels dated compared to newer competitors","No free plan available — starts at a monthly fee","Reporting and analytics are basic compared to industry-specific tools","Mobile app has limited functionality versus the web version"],
    useCases: ["Coaching businesses selling session packages and collecting intake info","Photography studios managing bookings across multiple photographers","Tutoring services with complex recurring appointment schedules"],
    startingPrice: "$20/mo",
    priceCurrency: "USD",
    lastReviewed: "2026-06-20",
  },
  ...
  },
  {
    ...
    {
    slug: "10to8",
    name: "Sign In Scheduling (formerly 10to8)",
    tagline: "Appointment scheduling with smart communication tools",
    description: "Sign In Scheduling, formerly known as 10to8, focuses on reducing no-shows with multi-channel reminders via SMS, email, and voice calls. Now part of the Sign In Solutions suite, it provides a booking system with two-way calendar sync, video integrations, and a client communication hub that consolidates all appointment-related messaging. SMS reminders are included even on the free tier.",
    category: "professional-services",
